...
<div class="col-md-8 col-md-offset-0" class="text-center" > 
        ...
        <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12 center">
            <h1 class="gallery-title text-center">Congelador</h1> 
     </div>
        <div align="center">
		    ...
		    <span class="glypicon glyphicon glyphicon-plus"></span>Nuevo Congelador</a>
        </div>
                                 ...
                                 <div class="panel panel-default">
                                   <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
                                    ...
                                    <div class="panel-heading">
                                      <h3 class="panel-title text-center">Nuevo Congelador </h3>
                                    </div>
                                  </div>
                               <div class="card-body">
