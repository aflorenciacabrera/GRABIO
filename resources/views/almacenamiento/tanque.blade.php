...
<div class="col-md-8 col-md-offset-0" class="text-center" > 
        ...
        <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12 center">
            <h1 class="gallery-title text-center">Tanque</h1> 
     </div>
        <div align="center">
		    ...
		    <span class="glypicon glyphicon glyphicon-plus"></span>Nuevo Tanque</a>
        </div>
                                 ...
                                 <div class="panel panel-default">
                                   <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
                                    ...
                                    <div class="panel-heading">
                                      <h3 class="panel-title text-center">Nuevo Tanque </h3>
                                    </div>
                                  </div>
                               <div class="card-body">
			                    <form method="POST" action="{{url('')}}">
			                        ...
			                        <div class="form-group row">
			                            <label for="name" class="col-md-2 col-form-label "> Varilla</label>
    ...
    <div class="row">
            ...
            <table class="table table-stripped table-bordered">
			      ...
			      <tbody>
			        ...
			        <tr>
			          <th scope="row">2</th>
			          	 <td><a href="{{ url('almacenamiento/posiciones') }}" type="button" class="btn btn-warning btn-circle ">A.2 <i class="glyphicon glyphicon-list"></i></a></td>
				          <td></td>
				           <td><a href="{{ url('almacenamiento/posiciones') }}" type="button" class="btn btn-success btn-circle " >C.2 <i class="glyphicon glyphicon-list"></i></a>
				          </td>
				          <td></td>
